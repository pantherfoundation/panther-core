...
snarkjs_pseudo_setup_groth16_step3 () {
    ...
    ${SNARKJS} groth16 setup compiled/mainAmmV1.r1cs ./powersOfTau28_hez_final_18.ptau compiled/amm_0000.zkey
}
...
snarkjs_phase2_zkey_verify_step7 () {
    ...
    ${SNARKJS} zkey verify compiled/mainAmmV1.r1cs ./powersOfTau28_hez_final_18.ptau compiled/amm_0003.zkey
}
...
snarkjs_final_zkey_verify_step9 () {
    ...
    ${SNARKJS} zkey verify compiled/mainAmmV1.r1cs ./powersOfTau28_hez_final_18.ptau compiled/amm_final.zkey
}
