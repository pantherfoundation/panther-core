...
circom_compile_v1_extended_step0 () {
    ...
    ${CIRCOM} --r1cs --wasm --sym -o compiled/ circuits/mainZAccountRegistrationV1.circom;
}
...
snarkjs_r1cs_info_v1_extended_step1 (){
    ...
    ${SNARKJS} r1cs info compiled/mainZAccountRegistrationV1.r1cs;
}

snarkjs_export_r1cs_json_step2 () {
    echo "*** snarkjs_export_r1cs_json_step2 ***";
    ${SNARKJS} r1cs export json compiled/mainZAccountRegistrationV1.r1cs compiled/mainZAccountRegistrationV1Extended.json
}
