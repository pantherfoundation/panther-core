...
snarkjs_pseudo_setup_groth16_step3 () {
    ...
    ${SNARKJS} groth16 setup compiled/mainZAccountRenewalV1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_0000.zkey
}
...
snarkjs_phase2_zkey_verify_step7 () {
    ...
    ${SNARKJS} zkey verify compiled/mainZAccountRenewalV1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_0003.zkey
}
...
snarkjs_final_zkey_verify_step9 () {
    ...
    ${SNARKJS} zkey verify compiled/mainZAccountRenewalV1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_final.zkey
}
