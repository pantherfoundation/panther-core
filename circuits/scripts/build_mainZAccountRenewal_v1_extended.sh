...
circom_compile_v1_extended_step0 () {
    ...
    ${CIRCOM} --r1cs --wasm --sym -o compiled/ circuits/main_zAccount_renewal_v1.circom;
}
...
snarkjs_r1cs_info_v1_extended_step1 (){
    ...
    ${SNARKJS} r1cs info compiled/main_zAccount_renewal_v1.r1cs;
}

snarkjs_export_r1cs_json_step2 () {
    echo "*** snarkjs_export_r1cs_json_step2 ***";
    ${SNARKJS} r1cs export json compiled/main_zAccount_renewal_v1.r1cs compiled/main_zAccount_renewal_v1_extended.json
}

snarkjs_pseudo_setup_groth16_step3 () {
    echo "*** snarkjs_pseudo_setup_groth16_step3 ***";
    ${SNARKJS} groth16 setup compiled/main_zAccount_renewal_v1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_0000.zkey
}
...
snarkjs_phase2_zkey_verify_step7 () {
    ...
    ${SNARKJS} zkey verify compiled/main_zAccount_renewal_v1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_0003.zkey
}
...
snarkjs_final_zkey_verify_step9 () {
    ...
    ${SNARKJS} zkey verify compiled/main_zAccount_renewal_v1.r1cs ./powersOfTau28_hez_final_17.ptau compiled/main_zAccount_renewal_v1_extended_final.zkey
}
