...
include "../../circuits/templates/selectable3TreeInclusionProofChecker.circom";

// Based upon the given leaf, path elements and indices, verify the root
...
component main {public [root]} = Selectable3TreeInclusionProofChecker(6, 20, 4);
