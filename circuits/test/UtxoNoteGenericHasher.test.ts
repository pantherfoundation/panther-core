...
describe('UtxoNoteGenericHasher circuit', async function (this: any) {
    let utxoNoteGenericHasher: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/utxoNoteGenericHasher.circom',
        );
        utxoNoteGenericHasher = await wasm_tester(input, opts);
    });
