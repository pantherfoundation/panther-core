...
describe('ZAccountNoteHasher2 circuit', async function (this: any) {
    let ZAccountNoteHasher2: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/ZAccountNoteHasher2.circom',
        );
        ZAccountNoteHasher2 = await wasm_tester(input, opts);
    });
