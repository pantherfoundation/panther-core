...
describe('UtxoNoteLeafHasher circuit', async function (this: any) {
    let utxoNoteLeafHasher: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/utxoNoteLeafHasher.circom',
        );
        utxoNoteLeafHasher = await wasm_tester(input, opts);
    });
