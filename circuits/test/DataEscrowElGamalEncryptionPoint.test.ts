...
describe('DataEscrowElGamalEncryptionPoint circuit', async function (this: any) {
    let dataEscrowElGamalEncryptionPoint: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/dataEscrowElGamalEncryptionPoint.circom',
        );
        dataEscrowElGamalEncryptionPoint = await wasm_tester(input, opts);
    });
