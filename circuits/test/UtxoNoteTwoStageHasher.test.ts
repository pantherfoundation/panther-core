...
describe('UtxoNoteTwoStageHasher circuit', async function (this: any) {
    let utxoNoteTwoStageHasher: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/utxoNoteTwoStageHasher.circom',
        );
        utxoNoteTwoStageHasher = await wasm_tester(input, opts);
    });
