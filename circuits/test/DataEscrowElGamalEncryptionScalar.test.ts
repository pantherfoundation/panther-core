...
describe('DataEscrowElGamalEncryptionScalar circuit', async function (this: any) {
    let dataEscrowElGamalEncryptionScalar: any;
    ...
    before(async function () {
        ...
        dataEscrowElGamalEncryptionScalar = await wasm_tester(input, opts);
    });
