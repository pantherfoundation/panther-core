...
// DataEscrowElGamalEncryptionScalar template is not used in any of the main circuit - Revisit during Stage8 - @sushma
describe('DataEscrowElGamalEncryptionScalar circuit', function (this: any) {
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/dataEscrowElGamalEncryptionScalar.circom',
        );
    ...
    /*******************************************************************************************************************
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////// component main = DataEscrowElGamalEncryptionScalar(3); ////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        1) 3 - scalar size
    ...
    xdescribe('Valid input signals', function () {
