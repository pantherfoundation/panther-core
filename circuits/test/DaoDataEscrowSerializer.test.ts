...
describe('DaoDataEscrowSerializer circuit', async function (this: any) {
    let daoDataEscrowSerializer: any;
    ...
    before(async function () {
        ...
        const input = path.join(
            opts.basedir,
            './test/circuits/daoDataEscrowSerializer.circom',
        );
        daoDataEscrowSerializer = await wasm_tester(input, opts);
    });
