...
// tokenId is LSBs
template IsZAssetIdEqualToUtxoZAssetIdTest() {
...
template IsZAssetTokenIdEqualToTokenIdTest() {
...
template IsUtxoTokenIdEqualToTokenIdTest() {
    signal input utxoZAssetId;
    signal input tokenId;
    signal input offset;
    signal input enabled;
