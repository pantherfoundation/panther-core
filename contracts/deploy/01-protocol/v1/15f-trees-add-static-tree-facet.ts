...
func.tags = ['add-static-tree', 'trees', 'trees-add-facet', 'protocol-v1'];
func.dependencies = ['static-tree', 'add-trees-diamond-loupe', 'trees-diamond'];
