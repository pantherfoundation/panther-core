...
import "../storage/BlacklistedZAccountsIdsRegistryStorageGap.sol";
    ...
    BinaryUpdatableTree
{
    ...
    constructor(
        address self,
        address pantherPool
    ) StaticRootUpdater(self) PantherPoolAuth(pantherPool) {}
    ...
    function addZAccountIdToBlacklist(
        ...
        _updateBlacklistedZAccountIdRegistryAndStaticRoots(
            _updatedRoot,
    ...
    function _getZAccountFlagAndLeafIndexes(
        ...
        require(flagIndex < 253, ERR_INVALID_ZACCOUNT_FLAG_POSITION);
    ...
    function _updateBlacklistedZAccountIdRegistryAndStaticRoots(
        bytes32 blacklistedZAccountIdRegistryTreeRoot,
        uint256 leafIndex
    ) private {
        _currentRoot = blacklistedZAccountIdRegistryTreeRoot;
        _updateStaticRoot(blacklistedZAccountIdRegistryTreeRoot, leafIndex);
    }
}
