...
import "./VerifyingKeyProvider.sol";
import "../../../common/crypto/EllipticCurveMath.sol";
...
abstract contract Verifier is EllipticCurveMath, VerifyingKeyProvider {
    function verifyOrRevert(
        uint160 circuitId,
        uint256[] memory input,
        SnarkProof memory proof
    ) internal view virtual {
        require(verify(circuitId, input, proof), "verification-failed");
    }
    ...
    function verify(
        ...
        VerifyingKey memory vk = _loadVerifyingKey(circuitId);
