...
class HonesMekleTree extends MerkleTree {
    constructor(leaves: bigint[], zeroValue: bigint, leafCount: number) {
        const asBuffer = HonesMekleTree.asRingBuffer(
            leaves,
            zeroValue,
            leafCount,
...
describe('SparseMerkleTree', () => {
    ...
    describe('constructor()', () => {
        it('should match tree generated by merkletreejs', () => {
            ...
            const honestTree = new HonesMekleTree(
                leaves,
                zeroValueHash,
